...
class ExperimentBuilder(object):
    ...
    def run_experiment(self):
        ...
        with tqdm.tqdm(initial=self.state['current_iter'],
            ...
            while (not self.args.eval_only) and (self.state['current_iter'] < (self.args.total_epochs * self.args.total_iter_per_epoch)) and (self.args.evaluate_on_test_set_only == False):
